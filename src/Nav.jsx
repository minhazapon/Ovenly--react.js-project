...
const Nav = () => {
   ...
   const NavZ = <>
     ...
     <li className="  nav text-xl " ><NavLink to='/page' >About Us</NavLink></li>
    ...
    return (
        <div>
        <div className="navbar  p-7 shadow  ">
        ...
        <img className=" h-[50px] w-[50px] " src="https://cdn-icons-png.flaticon.com/128/9352/9352761.png" alt="" />
        <a className=" text-2xl  play ">Ovenly</a>
        </div>
        </div>
